...
export const SIDEBAR_MENUS: Record<Role, SidebarConfig> = {
  [Role.SUPER_ADMIN]: {
    ...
    items: [
      ...
      {label: 'Users', icon:'/svg/users.svg', route:'users' },
      ...
      {label : 'RequestDemo', icon : 'svg/demo.svg',route:'demo-requests'},
  ...
  [Role.ADMIN]: {
    ...
    items: [
      ...
      { label: 'Exams', icon: '/svg/exams.svg', route: 'exams' },
      { label: 'Attendance', icon: '/svg/attendence.svg', route: 'attendance' },
      { label: 'Announcements', icon: '/svg/announcement.svg', route: 'announcements' },
      { label: 'Complaints', icon: '/svg/complaint.svg', route: 'complaints' },
      { label: 'Setting', icon: '/svg/setting.svg', route: 'settings' },
    ],
